...
//		
		...
		Object status = JOptionPane.showOptionDialog(frame, "Kindly Enter Your Gender Please",
		                                      "", -1, JOptionPane.QUESTION_MESSAGE, null,
		                                      options, options[1]);
		 gender=status.toString();
	
		Controller.eInstance().setPlayerGender(gender);

		Controller.eInstance().setPlayerName(name);
		JOptionPane.showMessageDialog(frame, "Nice to finally meet the cold blooded warrior "+name+", lets Get Started");
		frame = new JFrame();
...
//		frame.getContentPane().add(button5);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					String resp=Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).toString();
					textPane.setText(""+textPane.getText()+resp);
				}
				else if(selectedItem.contains("Go to"))
				{
					ArrayList<String> nRooms = Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).getNeigbourRooms();
					for(String nr:nRooms)
					{
						if(Controller.eInstance().getOnFloor()==6)
						{
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("cell block".toLowerCase()))
							{
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("cell # 1".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("cell # 2".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("torture room".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("hallway".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("staircase".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(250, 350, 61, 16);;
						...
						else if(Controller.eInstance().getOnFloor()==5)
						{
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("cell 3".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("cell 4".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("kennel".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("guard room".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("storage".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
						...
						else if(Controller.eInstance().getOnFloor()==4)
						{
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("dinning".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(40, 54, 61, 16);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("servant quater".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("kitchen".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(380, 350, 61, 16);;
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("pantry".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
						...
						{
							//lblP.setBounds(250, 350, 61, 16);
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("lobby".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(250, 350, 61, 16);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("Training room".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(40, 54, 61, 16);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("armoury".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("weaponary".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("wine cellar".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(380, 350, 61, 16);;
						...
						{
							//lblP.setBounds(250, 350, 61, 16);
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("common".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(250, 350, 61, 16);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("library".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(40, 54, 61, 16);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("garderobe".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("barracks".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
								lblP.setBounds(370,250, 61, 16);;
						...
						{
							//lblP.setBounds(250, 350, 61, 16);
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("Prep room".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("Reception".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("Morgue".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("warden office".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("safe".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
								textPane.setText(textPane.getText()+"\n\n"+resp);
							...
							if(selectedItem.toLowerCase().contains(nr.toLowerCase()) && selectedItem.toLowerCase().contains("exit".toLowerCase()))
							{
								String resp="Moving to "+nr.toLowerCase()+"\n";
				...
				else if(selectedItem.contains("Inspect"))
				{
					...
					{
						String resp=Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).doors();
						textPane.setText(textPane.getText()+"\n\n"+resp);
					}
				}
				else if(selectedItem.contains("Use"))
				{
					...
					{
						textPane.setText(textPane.getText()+"\n\n"+selectedItem.substring(4, selectedItem.length()) + "is used");
					}
					else
					{
						textPane.setText(textPane.getText()+"\n\n"+selectedItem.substring(4, selectedItem.length()) + "is not found");
				...
				else if(selectedItem.contains("Drop"))
				{
					...
					{
						textPane.setText(textPane.getText()+"\n\n"+selectedItem.substring(5, selectedItem.length()) + "is dropped");
					}
					else
					{
						textPane.setText(textPane.getText()+"\n\n"+selectedItem.substring(5, selectedItem.length()) + "is not found");
				...
				{
					Artifact artifact = Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).getArtifact(selectedItem);
					if( artifact!=null)
					{
						Controller.eInstance().getPlayer().getInventary().add(artifact);
						textPane.setText(textPane.getText()+"\n\n"+selectedItem.substring(7, selectedItem.length()) + " is picked up");
					}
					else
					{
						textPane.setText(textPane.getText()+"\n\n"+selectedItem.substring(7, selectedItem.length()) + " is not found");
				...
				{
					if(!Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).getPuzzles().isEmpty())
					{
						String resp="\n"+Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).getPuzzles().get(0).getHint();
						textPane.setText(""+textPane.getText()+resp);
					}
					else
					{
...
//				}
				...
				{
					if( !Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).getMonsters().isEmpty())
					{
						Controller.eInstance().getFloor(Controller.eInstance().getOnFloor()).getRoom(Controller.eInstance().getInRoom()).attackMonster(Controller.eInstance().getPlayer());
